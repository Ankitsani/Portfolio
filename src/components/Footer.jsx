        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <div className="">
              <span className={`text-lg font-bold ${
                ...
                ankit<span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">.dev</span>
              </span>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-3">
              ...
              <a 
                href="https://www.instagram.com/akki_saini_66/" 
                target="_blank" 
                rel="noopener noreferrer"
                className={`p-3 rounded-xl border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg group ${
                  isDarkMode 
              ...
              <a 
                href="https://x.com/AnkitSaini61473" 
                target="_blank" 
                rel="noopener noreferrer"
                className={`p-3 rounded-xl border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg group ${
                  isDarkMode 
    ...
    <div className="mt-8 pt-6 border-t border-white/5 text-center">
        <p className="text-sm opacity-70">
            ...
            <p className="text-xs opacity-50 mt-2">
                  © {new Date().getFullYear()} Ankit.dev — Crafted with ❤️ and caffeine ☕
            </p>
      </div>
      </div>
    </footer>
